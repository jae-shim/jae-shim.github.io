...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raytracer.data';
      var REMOTE_PACKAGE_BASE = 'raytracer.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_raytracer.data');

      };
      Module['addRunDependency']('datafile_raytracer.data');
...
var ASM_CONSTS = {
  ...
  var GL = {counter:1,buffers:[],programs:[],framebuffers:[],renderbuffers:[],textures:[],shaders:[],vaos:[],contexts:[],offscreenCanvases:{},queries:[],byteSizeByTypeRoot:5120,byteSizeByType:[1,1,2,2,4,4,4,2,3,4,8],stringCache:{},unpackAlignment:4,recordError:function recordError(errorCode) {
        ...
        return ret;
      },MAX_TEMP_BUFFER_SIZE:9830400,numTempVertexBuffersPerSize:64,log2ceilLookup:function(i) {
